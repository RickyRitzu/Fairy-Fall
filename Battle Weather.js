...
// --------------------------------------
/*:
* @plugindesc v2.0 Creates a weather during battle. Now compatible with Dynamic Weather System.
* @author: Soulpour777
* @help
...
(function() {
	...
	Spriteset_Battle.prototype.createLowerLayer = function() {
	    ...
	    if($gameSystem._battleWeather)this.createWeather();
			if (Soulpour777.WeatherEffectsSystem && $gameSystem._battleWeather)this.createDynamicWeathers();
	};
	...
	Spriteset_Battle.prototype.createDynamicWeathers = function() {
		this._dynamicweather = new VPS_DynamicWeatherSystem();
		this.addChild(this._dynamicweather);
	}
	...
	Spriteset_Battle.prototype.updateBattleWeather = function() {
	    ...
	    this._weather.origin.y = $gameMap.displayY() * $gameMap.tileHeight();
			...
			if (Soulpour777.WeatherEffectsSystem) {
				this._dynamicweather.type = $gameScreen.weatherTypePlus();
        this._dynamicweather.power = $gameScreen.weatherPowerPlus();
        this._dynamicweather.origin.x = $gameMap.displayX() * $gameMap.tileWidth();
        this._dynamicweather.origin.y = $gameMap.displayY() * $gameMap.tileHeight();
			}
